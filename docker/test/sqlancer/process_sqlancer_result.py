...
def process_result(result_folder):
    ...
    for test in tests:
        err_path = f"{result_folder}/{test}.err"
        out_path = f"{result_folder}/{test}.out"
        if not os.path.exists(err_path):
            ...
            paths.extend((err_path, out_path))
